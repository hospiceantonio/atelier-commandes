/* =========================================================
   ...
   Les CODES sont à garder secrets : ils sont destinés aux
   commerciaux qui présentent l'application — chaque saisie ouvre
   l'application pour un mois. Seules les EMPREINTES vont dans
   js/licence.js : elles ne permettent pas de retrouver les codes.
   ========================================================= */
...
console.log("CODE (secret, pour vos commerciaux)     EMPREINTE (à coller dans js/licence.js)");
